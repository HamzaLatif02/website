...
const LeftPanel: React.FC<Props> = ({ activeSection }) => {
  ...
  return (
    <aside className="px-8 py-16 lg:sticky lg:top-0 lg:h-screen lg:flex lg:flex-col lg:justify-between lg:px-12 lg:py-24">
      <div>
        ...
        <p className="text-xs font-mono leading-relaxed max-w-xs" style={{ color: 'rgba(255,255,255,0.45)' }}>
